 ...
 * API available to manipulate Karel. This class is in charge
...
function KarelIde(programLang="java", editor, canvas, initialWorld, speed = 0.5, lang="es", canvasWidth = 1000, canvasHeight=1000, setInitialWorldText=console.log, addMoveText=console.log, customInitialWorldDescription='', setAriaLabel=console.log) {
  let PATH_TO_ROOT = '../../'
    ...
    * --------------
    * Runs the code from the IDE editor without resetting Karel's world.
    ...
    * Function: Update
    * ------
    * Updates the world once every ACTION_HEARTBEATS number of heartbeats.
    */
   function update() {
    ...
    * world has been loaded. Draws Karel in front of beepers but behind walls.
    */
   function draw() {
      if (canvas) {
         clear();
